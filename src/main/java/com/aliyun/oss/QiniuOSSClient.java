...
//        return config.zone.getRegion();
    ...
    public Bucket createBucket(CreateBucketRequest createBucketRequest) throws OSSException, ClientException {
        ...
        // 0 表示标准存储；1 表示低频存储
        int storageType = ctype == StorageClass.IA || ctype == StorageClass.Archive ? 1 : 0;
        CannedAccessControlList acl = createBucketRequest.getCannedACL();
        // 0 公开  1 私有
        int _private = acl == CannedAccessControlList.Private ? 1 : 0;
        try {
...
//        return null;
    ...
    public void setBucketAcl(String bucketName, CannedAccessControlList cannedACL)
            throws OSSException, ClientException {
        // TODO sdk 不支持  https://developer.qiniu.com/kodo/api/3946/put-bucket-acl
    }
